...
export default function SuratMasukPage() {
  ...
  const [form, setForm] = useState({ 
    ...
    nomor: "", // Nomor surat dari pengirim
    pengirim: "", 
    perihal: "",
  ...
  const [editForm, setEditForm] = useState({ id: "", tanggal: "", nomor: "", pengirim: "", perihal: "", jenis: "", file_url: "" });
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    if (sukses) {
      setForm({ tanggal: new Date().toISOString().split("T")[0], nomor: "", pengirim: "", perihal: "", jenis: "Biasa" });
  ...
  const handleBukaEdit = (surat: any) => {
    setEditForm({ 
      ...
      pengirim: surat.pengirim, perihal: surat.perihal, jenis: surat.jenis || "Biasa", file_url: surat.file_url || "" 
    });
    setEditFile(null);
    setOpenEdit(true);
  };
            ...
            <DialogContent className="print:hidden sm:max-w-[500px]">
              ...
              <form onSubmit={onSubmit} className="space-y-4 pt-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input placeholder="Contoh: B-123/Kk.10/..." value={form.nomor} onChange={(e) => setForm({...form, nomor: e.target.value})} required />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  <Label>Perihal</Label>
                  <Input placeholder="Contoh: Undangan Rapat Koordinasi" value={form.perihal} onChange={(e) => setForm({...form, perihal: e.target.value})} required />
                </div>
